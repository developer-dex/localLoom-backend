 ...
 * tags:
 *   name: Admin Regions
 *   description: Region management (admin only)
 */
 ...
 * /regions:
 *   get:
 *     summary: List all regions (including inactive)
 *     tags: [Admin Regions]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *       409:
 *         description: Region name already exists
 *   delete:
 *     summary: Soft-delete region (sets isActive to false)
 *     tags: [Admin Regions]
 *     security:
 *       - bearerAuth: []
 *     parameters:
